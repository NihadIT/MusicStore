...
namespace MusicStore.Models
{
    ...
    {
        public static void Initialize(MusicStoreEntities entities)
        {
            entities.Database.EnsureCreated();

            if (entities.Genres.Any())
            {
            ...
            {
                  new Album { Title = "A Copland Celebration, Vol. I", Genre = genres.Single(g => g.Name == "Classical"), Price = 8.99M, Artist = artists.Single(a => a.Name == "Aaron Copland & London Symphony Orchestra"), AlbumArtUrl = $""},
